...
class PorteVideoPlayerScreen extends StatefulWidget {
  final String videoUrl;
  final String titre;
  PorteVideoPlayerScreen({Key key, this.videoUrl, this.titre})
      : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return _PorteVideoPlayerScreenState();
  }
}

class _PorteVideoPlayerScreenState extends State<PorteVideoPlayerScreen> {
